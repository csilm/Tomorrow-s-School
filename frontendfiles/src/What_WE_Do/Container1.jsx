  ...
  return (
    <div className='pt-10 lg:hidden'>
      ...
      <div className='text-md font-san text-left p-10'>
             ...
             Water The No. 1 of the basic need requirements for a healthy life is clean,
             ...
             the children or women of a family walk up to three hours to find a water source;
             often to collect from contaminated surface or stagnant water which they share with animals. 
             This kind of water is the main cause for illnesses like diarrhoea, bilharzia or typhoid fever
             – especially life-threatening to children.We want to make it
             <h1 className='text-lg font-bold'>our responsibility to help the school getting access to safe water</h1> 
              by financing the build and maintenance of an appropriate water resource to ensure that clean,
      ...
      think twice about it – we use the toilet, wash our hands, and that’s that. For children in 
      developing countries, however, this routine is a whole different story: 39% of Primary Schools 
      in Ethiopia only have limited sanitary services, 61% have none! And only 5% of these schools are 
      able to provide hygiene facilities including water and soap. In numbers this means that 25 million children
       are exposed to health-endangering bacteria and germs everyday. These circumstances lead to infections, illness
        and ultimately to absence and drop-outs of school or worse. Girls are particularly affected once a month.
       <h1 className='text-lg font-bold'>Building well-functioning sanitary facilities, install a sustainable waste
        management system and providing hygiene education
       </h1> 
       by financing the build and maintenance of an appropriate water resource to ensure that clean, fresh water
        is always available for students and teachers. The water will supply the sanitary facilities, ensure a higher
         hygiene practice and support the school food program.
      </div>
      </div>
      <div className='h-auto w-full flex flex-col flex-wrap justify-center items-center'>
      ...
      <div className='h-auto w-full flex flex-row flex-wrap justify-center items-center'>
        ...
        <div className='w-1/2 flex flex-col flex-wrap '>
          <h1 className='w-1/2 bg-yellow-500 pl-7 pr-7 p-3 font-sans font-bold text-lg'>Study</h1>
          <h1 className='w-full bg-yellow-500 pl-7 pr-7 p-3 font-sans font-bold text-lg mt-3'>Material</h1>
        </div>
       ...
       lack access to safe drinking water – 61 million people in Ethiopia. In rural areas,
        the children or women of a family walk up to three hours to find a water source; often
         ...
         This kind of water is the main cause for illnesses like diarrhoea, bilharzia or typhoid fever –
          especially life-threatening to children.We want to make it
        <h1 className='text-lg font-bold'>our responsibility to help the school getting access to safe water</h1> 
       by financing the build and maintenance of an appropriate water resource to ensure that clean, fresh water is
        always available for students and teachers. The water will supply the sanitary facilities, ensure a higher hygiene
      practice and support the school food program.
      </div>
      </div>
      <div className='h-auto w-full flex flex-col flex-wrap justify-center items-center'>
      ...
      <img src={Food} className='w-3/5 mt-16 m-5' alt="" />
        <div className='w-1/3 flex flex-col flex-wrap '>
          <h1 className='w-1/2 bg-yellow-500 pl-5 pr-5 p-3 font-sans font-bold text-lg'>Food</h1>
        </div>
      </div>
      <div className='text-md font-san text-left p-10'>
