...
const Footer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios
        .post("https://tomorrows-school-clone.onrender.com/subscribe", data)
  ...
  return (
    <div>
      <footer
        ...
        class="mt-20 text-center lg:text-left lg:px-10 text-white"
      >
          ...
          <div class="mx-auto container grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-14">
            <div>
              <h6 class="uppercase font-semibold mb-4 flex items-center ">
                {t("The Tomorrow School e.V.")}
              </h6>
              <p className="">
                {t(
                  "The Tomorrow School is a registered non-profit organization in Hamburg, Germany."
                )}
                <p className="mt-2"> {t("Register number: VR 24153.")}</p>
                <p className="mt-2">
                  {" "}
                  {t("Tax Identification No.: 17/440/23048.")}
                </p>
            ...
            <div class="">
              <h6 class="uppercase font-semibold mb-4">{t(" Quick links")}</h6>
              <p class="mb-4">
            ...
            <div class="">
              <h6 class="uppercase font-semibold mb-4"> {t("Contact us")}</h6>
              <p class="mb-4">
                <a href="#!" class="text-white">
                  {t("+49/162/2589")}
                </a>
              ...
              <p class="mb-4">
                <a href="#!" class="text-white">
                  {t("hello@tomorrow-school-org")}
                </a>
              </p>
              <p class="mb-4">
                <a href="#!" class="text-white">
                  {t("www.hello@tomorrow-school-org")}
                </a>
              </p>
            ...
            <div class="">
              ...
              <form onSubmit={handleSubmit}>
                <p class="flex items-center md:justify-start mb-4">
                  <div>
                    <input
                      ...
                      name="first_name"
                      id="first_name"
                      class="ring-2 focus:outline-none ring-gray-500 p-2 text-black "
                ...
                <p>
                  <button class="rounded-none bg-[#f7b944] p-2" type="submit">
                    {t("Subscribe")}
                  </button>
                </p>
              </form>
